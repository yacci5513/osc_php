	...
	<main class="d-flex justify-content-center align-items-center h-75">
		<form style="width: 500px;" action="/user/regist" method="POST">
			...
			<div class="mb-3">
			  ...
			  <br>
			  <button type="button" class="btn btn-secondary" onclick="checkID(); return false;">아이디 확인</button>
			...
			<button type="submit" id="chkbutton" class="btn btn-success float-end" disabled >가입</button>
		  </form>
	</main>
